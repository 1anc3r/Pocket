...
public final class APP_URL {
    ...
    public static final String HOME_URL     =   "http://api.coolapk.com/market/v2/api.php?method=getHomepageApkList&slm=1&p=1&apikey=5b90704e1db879af6f5ee08ec1e8f2a5";
    ...
    public static final String SEARCH_URL   =   "http://api.coolapk.com/market/v2/api.php?method=getSearchApkList&slm=1&q=%s&p=1&apikey=5b90704e1db879af6f5ee08ec1e8f2a5";
    ...
    public static final String DOWN_URL     =   "http://dl-cdn.coolapkmarket.com/down/%s?_upt=cfc751891500292886";
}
