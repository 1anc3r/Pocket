...
public class UpDownAnimatorAdapter extends me.lancer.pocket.mainui.view.cardstackview.AnimatorAdapter {

    public UpDownAnimatorAdapter(me.lancer.pocket.mainui.view.cardstackview.CardStackView cardStackView) {
        super(cardStackView);
    }
