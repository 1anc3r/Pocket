...
public class UpDownStackAnimatorAdapter extends me.lancer.pocket.mainui.view.cardstackview.AnimatorAdapter {

    public UpDownStackAnimatorAdapter(me.lancer.pocket.mainui.view.cardstackview.CardStackView cardStackView) {
        super(cardStackView);
    }

    protected void itemExpandAnimatorSet(final me.lancer.pocket.mainui.view.cardstackview.CardStackView.ViewHolder viewHolder, int position) {
    ...
    @Override
    protected void itemCollapseAnimatorSet(me.lancer.pocket.mainui.view.cardstackview.CardStackView.ViewHolder viewHolder) {
        int childTop = mCardStackView.getPaddingTop();
        for (int i = 0; i < mCardStackView.getChildCount(); i++) {
            View child = mCardStackView.getChildAt(i);
            child.clearAnimation();
            final me.lancer.pocket.mainui.view.cardstackview.CardStackView.LayoutParams lp =
