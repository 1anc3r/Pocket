...
public class HtmlTextView extends JellyBeanSpanFixTextView {
    ...
    boolean linkHit;
    @Nullable
    private me.lancer.pocket.mainui.view.htmltextview.ClickableTableSpan clickableTableSpan;
    @Nullable
    private me.lancer.pocket.mainui.view.htmltextview.DrawTableLinkSpan drawTableLinkSpan;
    ...
    /**
     * @see me.lancer.pocket.mainui.view.htmltextview.HtmlTextView#setHtml(int)
     */
    ...
    /**
     * @see me.lancer.pocket.mainui.view.htmltextview.HtmlTextView#setHtml(String)
     */
    ...
    public void setHtml(@NonNull String html, @Nullable Html.ImageGetter imageGetter) {
        final me.lancer.pocket.mainui.view.htmltextview.HtmlTagHandler htmlTagHandler = new me.lancer.pocket.mainui.view.htmltextview.HtmlTagHandler(getPaint());
