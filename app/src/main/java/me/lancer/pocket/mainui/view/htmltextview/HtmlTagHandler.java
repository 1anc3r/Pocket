...
public class HtmlTagHandler implements Html.TagHandler {
        ...
        if (opening) {
            ...
            if (tag.equalsIgnoreCase(UNORDERED_LIST)) {
                ...
                if (tableTagLevel == 0) {
                    ...
                    me.lancer.pocket.mainui.view.htmltextview.ClickableTableSpan myClickableTableSpan = null;
                    if (clickableTableSpan != null) {
                        myClickableTableSpan = clickableTableSpan.newInstance();
                        myClickableTableSpan.setTableHtml(tableHtml);
                    }

                    me.lancer.pocket.mainui.view.htmltextview.DrawTableLinkSpan myDrawTableLinkSpan = null;
    ...
    public void setClickableTableSpan(me.lancer.pocket.mainui.view.htmltextview.ClickableTableSpan clickableTableSpan) {
