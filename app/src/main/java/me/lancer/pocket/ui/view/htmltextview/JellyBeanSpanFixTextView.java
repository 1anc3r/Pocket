...
package me.lancer.pocket.ui.view.htmltextview;
...
import me.lancer.pocket.ui.view.htmltextview.*;
...
public class JellyBeanSpanFixTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void fixOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (text instanceof Spanned) {
            ...
            if (me.lancer.pocket.ui.view.htmltextview.HtmlTextView.DEBUG) {
                Log.d(me.lancer.pocket.ui.view.htmltextview.HtmlTextView.TAG, "The text isn't a Spanned");
            }
    ...
    private void fixSpannedWithSpaces(SpannableStringBuilder builder, int widthMeasureSpec,
        ...
        if (me.lancer.pocket.ui.view.htmltextview.HtmlTextView.DEBUG) {
            ...
            Log.d(me.lancer.pocket.ui.view.htmltextview.HtmlTextView.TAG, "fixSpannedWithSpaces() duration in ms: " + fixDuration);
        }
    }
    ...
    private FixingResult addSpacesAroundSpansUntilFixed(SpannableStringBuilder builder,
        ...
        if (me.lancer.pocket.ui.view.htmltextview.HtmlTextView.DEBUG) {
            Log.d(me.lancer.pocket.ui.view.htmltextview.HtmlTextView.TAG, "Could not fix the Spanned by adding spaces around spans");
        }
    ...
    private void fallbackToString(int widthMeasureSpec, int heightMeasureSpec) {
        if (me.lancer.pocket.ui.view.htmltextview.HtmlTextView.DEBUG) {
            Log.d(me.lancer.pocket.ui.view.htmltextview.HtmlTextView.TAG, "Fallback to unspanned text");
        }
