...
public class AllMoveDownAnimatorAdapter extends me.lancer.pocket.ui.view.cardstackview.AnimatorAdapter {

    public AllMoveDownAnimatorAdapter(me.lancer.pocket.ui.view.cardstackview.CardStackView cardStackView) {
        super(cardStackView);
    }

    protected void itemExpandAnimatorSet(final me.lancer.pocket.ui.view.cardstackview.CardStackView.ViewHolder viewHolder, int position) {
    ...
    @Override
    protected void itemCollapseAnimatorSet(me.lancer.pocket.ui.view.cardstackview.CardStackView.ViewHolder viewHolder) {
        int childTop = mCardStackView.getPaddingTop();
        for (int i = 0; i < mCardStackView.getChildCount(); i++) {
            View child = mCardStackView.getChildAt(i);
            child.clearAnimation();
            final me.lancer.pocket.ui.view.cardstackview.CardStackView.LayoutParams lp =
