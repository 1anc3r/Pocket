        ...
        if (opening) {
            ...
            if (tag.equalsIgnoreCase(UNORDERED_LIST)) {
                ...
                if (tableTagLevel == 0) {
                    ...
                    me.lancer.pocket.ui.view.htmltextview.ClickableTableSpan myClickableTableSpan = null;
                    if (clickableTableSpan != null) {
                        myClickableTableSpan = clickableTableSpan.newInstance();
                        myClickableTableSpan.setTableHtml(tableHtml);
                    }

                    me.lancer.pocket.ui.view.htmltextview.DrawTableLinkSpan myDrawTableLinkSpan = null;
