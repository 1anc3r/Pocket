package me.lancer.pocket.info.mvp.system.fragment;
...
public class SystemFragment extends BaseFragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        Fragment newfragment = new SystemListFragment();
        Bundle data = new Bundle();
        data.putInt("id", 0);
        data.putString("title", "身体部位");
        newfragment.setArguments(data);
        adapter.addFrag(newfragment, "身体部位");

        newfragment = new SystemListFragment();
        data = new Bundle();
        data.putInt("id", 1);
        data.putString("title", "科室分类");
        newfragment.setArguments(data);
        adapter.addFrag(newfragment, "科室分类");
