...
public class KnowledgeFragment extends BaseFragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        Fragment newfragment = new KnowledgeListFragment();
        Bundle data = new Bundle();
        data.putInt("id", 0);
        data.putString("title", "医学资讯");
        newfragment.setArguments(data);
        adapter.addFrag(newfragment, "医学资讯");

        newfragment = new KnowledgeListFragment();
        data = new Bundle();
        data.putInt("id", 1);
        data.putString("title", "医学知识");
        newfragment.setArguments(data);
        adapter.addFrag(newfragment, "医学知识");
