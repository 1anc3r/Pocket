...
public class PhotoDetailNoBarActivity extends PresenterActivity<PhotoPresenter> implements IPhotoView {
...
//    };z
    ...
    public static void startActivity(Activity activity, String img, String title, ImageView ImageView) {
        ...
        intent.setClass(activity, PhotoDetailNoBarActivity.class);
