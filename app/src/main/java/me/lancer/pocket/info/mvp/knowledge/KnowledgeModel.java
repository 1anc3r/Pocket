...
public class KnowledgeModel {
    ...
    public KnowledgeModel(IKnowledgePresenter presenter) {
    ...
    private List<KnowledgeBean> getClassifyFromContent(int type, String content) {
        try {
    ...
    private List<KnowledgeBean> getListFromContent(int type, String content) {
        try {
            List<KnowledgeBean> list = new ArrayList<>();
            JSONObject jsonObj = new JSONObject(content);
            JSONArray jsonArr = jsonObj.getJSONArray("tngou");
    ...
    private List<KnowledgeBean> getNewsFromContent(int type, String content) {
        try {
            List<KnowledgeBean> list = new ArrayList<>();
            JSONObject jsonObj = new JSONObject(content);
            JSONArray jsonArr = jsonObj.getJSONArray("tngou");
    ...
    private KnowledgeBean getShowFromContent(int type, String content) {
        try {
            KnowledgeBean bean = new KnowledgeBean();
            JSONObject jsonObj = new JSONObject(content);
    ...
    private List<KnowledgeBean> getSearchFromContent(int type, String content) {
        try {
            List<KnowledgeBean> list = new ArrayList<>();
            JSONObject jsonObj = new JSONObject(content);
            JSONArray jsonArr = jsonObj.getJSONArray("tngou");
