...
import me.lancer.pocket.info.mvp.novel.manager.SettingManager;
import me.lancer.pocket.util.AppUtil;
import me.lancer.pocket.util.FileUtil;
...
public class PageFactory {
    ...
    private List<NovelBean.Chapters> chaptersList;
    ...
    public PageFactory(Context context, String bookId, List<NovelBean.Chapters> chaptersList) {
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
                       List<NovelBean.Chapters> chaptersList) {
        mContext = context;
        mWidth = width;
        mHeight = height;
        mFontSize = fontSize;
        ...
        mTitlePaint.setColor(ContextCompat.getColor(AppUtil.getAppContext(), R.color.chapter_title_day));
