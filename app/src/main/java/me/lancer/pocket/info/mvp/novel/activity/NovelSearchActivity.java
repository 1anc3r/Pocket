...
public class NovelSearchActivity extends PresenterActivity<NovelPresenter> implements INovelView {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 3:
                    if (msg.obj != null) {
                        mList = (List<NovelBean>) msg.obj;
                        mAdapter = new NovelAdapter(NovelSearchActivity.this, mList);
...
//            presenter.loadList(keyword);
    ...
    private void initView() {
        ...
        mAdapter = new NovelAdapter(this, mList);
        mRecyclerView.setAdapter(mAdapter);
    }
