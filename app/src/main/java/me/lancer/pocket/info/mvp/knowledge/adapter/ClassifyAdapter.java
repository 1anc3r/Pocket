...
public class ClassifyAdapter extends RecyclerView.Adapter<ClassifyAdapter.ViewHolder> {
    ...
    public ClassifyAdapter(Context context, Handler handler, int type, List<KnowledgeBean> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_horiz, viewGroup, false);
