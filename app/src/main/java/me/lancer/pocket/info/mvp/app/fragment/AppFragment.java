...
import me.lancer.pocket.info.mvp.app.activity.AppSearchActivity;
...
public class AppFragment extends BaseFragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        data.putInt("id", 0);
        data.putString("title", "本机应用");
        newfragment.setArguments(data);
        adapter.addFrag(newfragment, "本机应用");

        newfragment = new AppListFragment();
        data = new Bundle();
        data.putInt("id", 1);
        data.putString("title", "应用市场");
        newfragment.setArguments(data);
        adapter.addFrag(newfragment, "应用市场");
